...
import {
  ...
  Activity, FlaskConical, ClipboardList, Plus, Sparkles,
} from 'lucide-react';
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-3">
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        <Button asChild size="sm" className="h-9 rounded-xl text-xs font-semibold shadow-sm shadow-hospital-600/20 flex-shrink-0">
