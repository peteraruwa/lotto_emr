    ...
    items: [
      {
        category: 'Gait',
        type: 'single_select',
        options: ['Normal', 'Antalgic gait', 'Trendelenburg gait', 'Hemiplegic gait', 'Ataxic gait', 'Unable to walk'],
        default: 'Normal',
      },
      {
        category: 'Spine',
        ...
        options: [
          ...
          'Restricted spinal extension',
          'Restricted lateral flexion',
        ],
        default_selected: ['Normal spinal alignment'],
      },
      {
        category: 'Joint Involvement',
        type: 'free_numeric_text',
        placeholder: 'e.g. Right knee, both wrists, bilateral small joints of hands…',
      },
      {
        category: 'Swelling',
        type: 'multi_select',
        ...
        default_selected: ['No joint swelling'],
      },
      {
        category: 'Tenderness',
        type: 'multi_select',
        options: [
          ...
          'Wrist — right',
          'Wrist — left',
          'Small joints of hand — right',
          'Small joints of hand — left',
          'Hip — right',
          'Hip — left',
          'Knee — right',
          'Knee — left',
          'Ankle — right',
          'Ankle — left',
          'Small joints of foot — right',
          'Small joints of foot — left',
        ],
        default_selected: ['No joint tenderness'],
      },
      {
        ...
        options: [
          ...
          'Restricted — knee',
          'Restricted — spine',
          'Restricted — multiple joints',
        ],
        default: 'Full range of motion in all joints',
      },
      {
        category: 'Muscle Bulk / Wasting',
        type: 'single_select',
        options: ['Normal muscle bulk', 'Mild wasting', 'Moderate wasting', 'Severe wasting'],
        default: 'Normal muscle bulk',
      },
      {
        category: 'Deformity',
        type: 'multi_select',
      ...
      },
      {
        ...
        options: [
          'Not performed',
          'McMurray test — positive (right)',
          'McMurray test — positive (left)',
          'Lachman test — positive (right)',
          'Lachman test — positive (left)',
          'Straight leg raise — positive (right)',
          'Straight leg raise — positive (left)',
          'Finkelstein test — positive',
          'FABER test — positive (right)',
          'FABER test — positive (left)',
        ],
        default_selected: ['Not performed'],
      },
    ],
